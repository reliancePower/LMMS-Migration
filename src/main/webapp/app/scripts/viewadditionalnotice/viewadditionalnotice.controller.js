(function() {
	...
	angular.module('regCalApp.viewadditionalnotice').controller('ViewAdditionalNoticeController',
			ViewAdditionalNoticeController);

	ViewAdditionalNoticeController.$inject = [ '$state', 'viewAdditionalNoticeService',
	...
	/* @ngInject */
	function ViewAdditionalNoticeController($state, viewAdditionalNoticeService, localStorageService,
		...
		(function activate() {
			...
			vm.gstin = vm.caseDetails.gstin;
			vm.caseId = vm.caseDetails.caseId;
			vm.gstStatus = vm.caseDetails.gstStatus;
			...
			// New code
			vm.intimationArray = vm.caseDetails.intimationArray;
			vm.noticesArray = vm.caseDetails.noticesArray;
			vm.repliesArray = vm.caseDetails.repliesArray;
			vm.reportsArray = vm.caseDetails.reportsArray;
