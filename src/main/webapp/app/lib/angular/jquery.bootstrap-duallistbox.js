  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '   <div class="btn-group buttons" style = "display:inline-flex;color:white!important;">' +
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
       ...
       // this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('far fa-angle-double-right');
        //this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('far fa-angle-double-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
